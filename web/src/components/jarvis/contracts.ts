...
export const fallbackApprovalCards: JarvisApprovalCard[] = [
  {
    ...
    disabled_reason: "Backend-gated: crea preview y approval en /mark-3/execution antes de dispatch.",
  ...
  },
  {
    ...
    disabled_reason: "Critical blocked until stronger double/triple approval is configured.",
  ...
  },
  {
    ...
    disabled_reason: "Forbidden: credentials and secrets remain protected.",
...
export function fallbackDashboard(reason: "loading" | "offline" | "error"): JarvisDashboardStatus {
  return {
    ...
    approvals: {
      ...
      frontend_can_modify_scope: true,
    ...
    conversational_intake: {
      schema_version: "jarvis.conversational_intake.v1",
      state: {
      ...
      sample: {
        intake: {
          ...
          safe_to_prepare_preview: true,
          safe_to_dispatch_to_hermes: false,
        },
        classification: {
          intent_detected: "project_review_preview",
          confidence: 0.82,
          risk_level: "low",
          approval_level: "direct",
          requires_approval: false,
          ...
          requires_clarification: false,
          denied: false,
          next_safe_action: "prepare_project_review_preview",
          safe_to_dispatch_to_hermes: false,
        },
    ...
    brain_adapter: {
      schema_version: "jarvis.llm_brain_adapter.v1",
      state: {
        mode: "safe_brain_adapter_prepare_only",
        default_provider: "deterministic_local",
        current_provider: "deterministic_local",
      ...
      providers: {
        deterministic_local: {
          ...
          provider_mode: "local_deterministic_prepare_only",
          available: true,
          default_provider: "deterministic_local",
          external_llm_enabled: false,
          external_provider_called: false,
        ...
        disabled_external_llm: {
          provider_name: "disabled_external_llm",
          provider_mode: "external_provider_disabled_by_policy",
          available: false,
          default_provider: "deterministic_local",
          external_llm_enabled: false,
          external_provider_called: false,
      ...
      sample: {
        brain_response: {
          ...
          requires_approval: false,
          can_prepare_preview: true,
          cannot_execute_reason: "Esta PR solo prepara intake/preview/brain response; Hermes dispatch sigue deshabilitado.",
          suggested_next_action: "prepare_project_review_preview",
          hermes_dispatch_allowed: false,
          external_provider_called: false,
          provider_name: "deterministic_local",
          provider_mode: "local_deterministic_prepare_only",
      ...
      contracts: {
        ...
        provider_status_schema_version: "jarvis.brain_provider_status.v1",
    ...
    memory_brain: {
      ...
      why_jarvis_remembers: [
        "JARVIS no tiene memoria personal persistida por defecto en el fallback.",
        "La memoria nunca concede permisos ni autoriza ejecución.",
      ],
      explanation_preview: {
        why_jarvis_remembers: ["No approved persistent memory has evidence yet; unknown is preserved."],
        what_memory_influenced: ["No active memory influenced this preview."],
        pending_approval: [],
      },
      compaction: {
    ...
    persistent_audit: {
      ...
      state: {
        mode: "in_memory_metadata_audit_ledger",
        available: true,
        persistent: false,
        metadata_only: true,
        event_count: 0,
        storage_configured: false,
        storage_path: ".jarvis/audit/persistent_audit.sqlite3",
        tamper_evident: true,
    ...
    remote_channels: {
      ...
      remote_kill_switch: { enabled: false },
    ...
    telegram_readiness: {
      provider_status: "disabled_by_default_or_incomplete",
      token_present: false,
    ...
    external_operations: {
      ...
      deploy: { dry_run_default: true, production_deploy_default: false, dns_changes_enabled: false },
      email: { draft_default: true, send_enabled_by_default: false, mass_email_enabled: false },
      payments: { live_mode_blocked_by_default: true, money_movement_enabled: false, fake_revenue_allowed: false },
    ...
    visual_command_center_pilot: {
      ...
      read_only_checks: ["governed_post_only", "no_execute_route", "manual_get_user_media_only", "manual_media_recorder_only", "no_audio_context_capture", "no_camera_snapshot_storage", "no_money_movement", "no_fake_metrics"].map((name) => ({
        name,
        status: "passed",
        evidence: name,
