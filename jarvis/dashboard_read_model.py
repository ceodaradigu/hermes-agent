    ...
    *,
    ...
    payload = {
        ...
        "modules": [
            ...
            _module(
                "Phase 9 Product Operator",
                "prepare-only" if phase_9_status.get("prepare_only") else UNKNOWN,
                "/mark-3/product-operator/status",
                "product_mission_money_roi_prepare_only",
        ...
        "finance": {
            ...
            "source": "No measurement evidence connected to this legacy finance read model. Phase 9 revenue tracker is exposed under product_operator.revenue_tracker.",
        },
        "adaptive_product_builder": adaptive_product_builder,
        "product_builder": {
            "stages": [stage["name"] for stage in adaptive_product_builder["stages"]],
            "phase_9_builder_candidates": phase_9_status.get("builder_candidates", []),
            "phase_9_active_product_missions": phase_9_status.get("product_missions", []),
            "phase_9_experiments": phase_9_status.get("experiments", []),
            "phase_9_roi_decisions": phase_9_status.get("roi_decisions", []),
    ...
    *,
    ...
    return {
        "state": {
            ...
            "phase_9_status_endpoint": _route_exists(route_path_set, "/mark-3/phase-9/status"),
            "product_operator_endpoint": _route_exists(route_path_set, "/mark-3/product-operator/status"),
        ...
        "checks": [
            ...
            _doctor_check(
                "product_operator",
                "ok" if _route_exists(route_path_set, "/mark-3/product-operator/status") else "missing",
