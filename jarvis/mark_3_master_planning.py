...
def get_mark_3_macro_roadmap() -> Dict[str, Any]:
    definitions = [
        ...
        (134, "Mark 3 Continuous Learning: Outcome Memory, Experiments, Tech Radar", "Learn from evidence while keeping persistence and activation governed.", ["experiment registry", "outcome and failure memory", "ROI memory", "tech radar"], ["learning is reviewable, reversible, and evidence-linked"], False),
        (135, "Mark 3 Multi-Agent Orchestration: Roles, Budgets, Locks, Conflict Resolution", "Coordinate specialized agents without losing policy or human control.", ["agent roles", "permissions", "locks", "budgets", "handoffs", "conflict resolution"], ["agents cannot exceed role, budget, lock, or approval"], False),
        (136, "Mark 3 Revenue Product Factory: Controlled Opportunity-to-SaaS Pipeline", "Build a governed opportunity, product, monetization, and measurement pipeline.", ["niche validation", "product blueprint", "landing and pricing candidates", "measurement", "kill or continue gate"], ["no fake revenue or costs; external actions remain risk-gated"], False),
        (137, "Mark 3 Local Routine Scheduler: Supervised Autonomy", "Run bounded recurring work locally on David's current computer.", ["routine registry", "local scheduler", "health reports", "budgets", "stop controls"], ["no uncontrolled recurrence; local-first operation proven"], False),
        (138, "Mark 3 Authorized Account and Credential Assistance", "Support official recovery and security workflows for owned or authorized accounts.", ["consent and scope", "official recovery flows", "secure inventory plan", "2FA and access audit"], ["no bypass, theft, plaintext secret storage, or unauthorized access"], False),
        (139, "Mark 3 Moonshot Lab: Hard Problems, Research, Prototypes, Evidence", "Create an honest, stage-gated engine for ambitious research and prototypes.", ["hypothesis registry", "experiments", "prototype candidates", "evidence scoring", "uncertainty"], ["no overclaiming; stage gates and safety review pass"], False),
        (140, "Mark 3 Release Candidate Hardening and Controlled Pilot", "Harden Mark 3 and run a real bounded pilot under visible human control.", ["cross-system audits", "kill switch verification", "pilot", "post-mortem", "RC runbook"], ["pilot evidence supports RC decision with no critical policy gaps"], False),
    ]
