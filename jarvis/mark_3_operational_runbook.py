...
class Mark3OperationalRunbook:
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "steps": [
                "Open the main repo or current pilot-hardening worktree and activate ~/venvs/hermes-agent, then export PYTHONPATH=.",
                ...
                "After tests and review pass, close the PR outside Codex with jarvis-finish-pr \"Mark 3 Pilot Findings Hardening\".",
            ],
            "validation": [
                "git diff --check",
