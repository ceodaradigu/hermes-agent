    ...
    events = [
        ...
        _event(
            ...
            _get(dashboard_status, "wake_runtime.state.mode", "manual_fixture_wake_runtime_opt_in"),
            {
                ...
                "configured_phrase": _get(dashboard_status, "wake_runtime.state.configured_phrase", "jarvis"),
        ...
        _event(
            ...
            _get(dashboard_status, "phase_12_status.status", "real_always_on_jarvis_mvp_ready"),
            {
                "schema_version": _get(dashboard_status, "phase_12_status.schema_version", "jarvis.phase_12_real_always_on_mvp.v1"),
                "real_always_on_controller": True,
                "router_backed_conversation": True,
                "governed_local_actions": True,
        ...
        _event(
            ...
            _get(dashboard_status, "always_on_runtime.state.mode", "local_always_on_controller_pilot"),
            {
                "schema_version": _get(dashboard_status, "always_on_runtime.schema_version", "jarvis.phase_12.always_on_runtime.v1"),
                "enabled": _bool(_get(dashboard_status, "always_on_runtime.state.enabled", False)),
                "wake_listening": _bool(_get(dashboard_status, "always_on_runtime.state.wake_listening", False)),
                "conversation_active": _bool(_get(dashboard_status, "always_on_runtime.state.conversation_active", False)),
                "primary_wake_phrase": _get(dashboard_status, "always_on_runtime.primary_wake_phrase", "JARVIS"),
                "supported_wake_phrases": _get(dashboard_status, "always_on_runtime.supported_wake_phrases", ["JARVIS"]),
                "experimental_wake_aliases": _get(dashboard_status, "always_on_runtime.experimental_wake_aliases", ["Hola JARVIS"]),
                "experimental_aliases_best_effort": _bool(_get(dashboard_status, "always_on_runtime.experimental_aliases_best_effort", True)),
                "supported_stop_phrases": _get(dashboard_status, "always_on_runtime.supported_stop_phrases", ["para", "cállate"]),
                "continuous_full_transcription": False,
                "raw_audio_stored_by_default": False,
                "wake_phrase_can_approve": False,
                "wake_phrase_can_execute": False,
                "last_wake_phrase": _get(dashboard_status, "always_on_runtime.last_wake_greeting.matched_wake_phrase", ""),
                "wake_greeting_status": _get(dashboard_status, "always_on_runtime.last_wake_greeting.status", ""),
                "wake_greeting_text": _get(dashboard_status, "always_on_runtime.last_wake_greeting.assistant_text", ""),
                "wake_greeting_persona": _get(dashboard_status, "always_on_runtime.last_wake_greeting.persona_mode", ""),
                "pending_wake_greeting": _bool(_get(dashboard_status, "always_on_runtime.state.pending_wake_greeting", False)),
                "wake_greeting_voice_output_requested": _bool(
                    _get(dashboard_status, "always_on_runtime.last_wake_greeting.voice_output_requested", False)
                ),
                "wake_greeting_approved_action": False,
                "ui_presence_recent": _bool(_get(dashboard_status, "always_on_runtime.ui_presence.recent", False)),
                "ui_presence_path": _get(dashboard_status, "always_on_runtime.ui_presence.last.path", ""),
                "browser_open_cooldown_active": _bool(_get(dashboard_status, "always_on_runtime.browser_open.cooldown_active", False)),
                "last_browser_open_at": _get(dashboard_status, "always_on_runtime.browser_open.last_open_at", ""),
                "optional_openwakeword_ready": _bool(_get(dashboard_status, "always_on_runtime.dependencies.optional_audio_wake_loop_available", False)),
                "real_microphone_wake_available": _bool(_get(dashboard_status, "always_on_runtime.wake_listener.state.real_microphone_wake_available", False)),
                "real_microphone_wake_active": _bool(_get(dashboard_status, "always_on_runtime.wake_listener.state.wake_active", False)),
                "selected_wake_backend": _get(dashboard_status, "always_on_runtime.wake_listener.state.selected_backend", "unavailable"),
                "wake_backend_name": _get(dashboard_status, "always_on_runtime.wake_listener.engine.name", "unavailable"),
                "transcript_ingest_test_only": _bool(_get(dashboard_status, "always_on_runtime.transcript_ingest_endpoint.test_only", True)),
            },
        ),
        _event(
            generated_at,
            "phase_12_conversation_state",
            "/mark-3/phase-12/conversation/status",
            _get(dashboard_status, "phase_12_conversation.state.mode", "router_backed_conversation_brain"),
            {
                "schema_version": _get(dashboard_status, "phase_12_conversation.schema_version", "jarvis.phase_12.conversation_brain.v1"),
                "spanish_default": _bool(_get(dashboard_status, "phase_12_conversation.state.spanish_default", True)),
                "conversation_history_enabled": _bool(_get(dashboard_status, "phase_12_conversation.state.conversation_history_enabled", True)),
                "openrouter_configured": _bool(_get(dashboard_status, "phase_12_conversation.state.openrouter_configured", False)),
                "openrouter_live_calls_enabled": _bool(_get(dashboard_status, "phase_12_conversation.state.openrouter_live_calls_enabled", False)),
        ...
        _event(
            generated_at,
            "phase_12_action_state",
            "/mark-3/phase-12/actions/status",
            _get(dashboard_status, "phase_12_actions.state.mode", "governed_local_action_launcher"),
            {
                "schema_version": _get(dashboard_status, "phase_12_actions.schema_version", "jarvis.phase_12.governed_actions.v1"),
                "known_app_count": _get(dashboard_status, "phase_12_actions.state.known_app_count", 0),
                "safe_url_open_real": True,
                "web_search_real": True,
                "known_app_launch_real_when_path_resolves": True,
                "freeform_shell_allowed": False,
                "raw_command_from_ui_allowed": False,
                "form_submit_requires_approval": True,
        ...
        _event(
            ...
            _get(dashboard_status, "phase_12_voice.state.mode", "hybrid_browser_fallback_local_tts_optional"),
            {
                "schema_version": _get(dashboard_status, "phase_12_voice.schema_version", "jarvis.phase_12.voice_stack.v1"),
                "browser_speech_synthesis_fallback": True,
                "voice_output_default_enabled": _bool(_get(dashboard_status, "phase_12_voice.state.voice_output_default_enabled", True)),
                "wake_greeting_spoken_by_default": _bool(_get(dashboard_status, "phase_12_voice.state.wake_greeting_spoken_by_default", True)),
                "piper_binary_configured": _bool(_get(dashboard_status, "phase_12_voice.providers.piper_cli.configured", False)),
                "piper_ready": _bool(_get(dashboard_status, "phase_12_voice.providers.piper_cli.ready", False)),
                "gpt_sovits_sidecar_ready": _bool(_get(dashboard_status, "phase_12_voice.providers.gpt_sovits.ready", False)),
                "copyrighted_voice_clone": False,
        ...
        _event(
            ...
            _get(dashboard_status, "phase_12_remote.state.mode", "tailscale_first_secure_remote_bridge_mvp"),
            {
                "schema_version": _get(dashboard_status, "phase_12_remote.schema_version", "jarvis.phase_12.secure_remote_bridge.v1"),
                "enabled": _bool(_get(dashboard_status, "phase_12_remote.state.enabled", False)),
                "mode": _get(dashboard_status, "phase_12_remote.state.mode_configured", "tailscale"),
                "tailscale_cli_available": _bool(_get(dashboard_status, "phase_12_remote.tailscale.cli_available", False)),
                "kill_switch_enabled": _bool(_get(dashboard_status, "phase_12_remote.kill_switch.enabled", False)),
                "public_unauthenticated_exposure": False,
                "raw_pc_port_exposed": False,
                "iphone_direct_hermes_allowed": False,
        ...
        _event(
            ...
            _get(dashboard_status, "phase_12_startup.state.mode", "single_command_startup_contract"),
            {
                "schema_version": _get(dashboard_status, "phase_12_startup.schema_version", "jarvis.phase_12.startup_contract.v1"),
                "backend_port": _get(dashboard_status, "phase_12_startup.ports.backend", 9119),
                "frontend_port": _get(dashboard_status, "phase_12_startup.ports.frontend", 5173),
                "frontend_proxy_target": _get(dashboard_status, "phase_12_startup.ports.frontend_proxy_target", "http://127.0.0.1:9119"),
                "port_confusion_fixed": _bool(_get(dashboard_status, "phase_12_startup.ports.port_confusion_fixed", True)),
                "startup_script": _get(dashboard_status, "phase_12_startup.commands.start", "scripts/jarvis-start"),
                "doctor_script": _get(dashboard_status, "phase_12_startup.commands.doctor", "scripts/jarvis-doctor"),
                "voice_default_on": _bool(_get(dashboard_status, "phase_12_startup.checks.voice_default_on", True)),
                "secrets_exposed": False,
            },
        ),
        _event(
