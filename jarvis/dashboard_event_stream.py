...
def _risk_level_for_event(event_type: str) -> str:
    ...
    if event_type == "brain_state":
        return "intent_risk_preview"
    if event_type in {"approval_state", "spoken_approval_state", "risk_state", "execution_state", "phase_2_state", "phase_6_state", "phase_7_state", "phase_8_state", "remote_channel_state", "external_operation_state", "budget_guard_state", "payment_provider_state", "action_catalog_state", "policy_state"}:
