...
def test_pr_161_orb_is_reliable_canvas_particle_sphere_with_emergent_core_and_reactivity():
    ...
    for marker in (
        "particleBudget: isStopped ? 900 : isSpeaking ? 3800",
        "isThinking ? 3500",
        'visualState === "listening" ? 3200',
        "isTranscribing ? 3200",
        "textReactiveActive ? 3000",
        "speakingSpikeEnergy = isStopped ? 0 : isSpeaking ? 1",
        "radialSpikeEnergy = isStopped ? 0 : isError ? 1.05 : isAlert ? 0.84",
